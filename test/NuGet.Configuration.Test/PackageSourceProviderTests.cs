...
";
        ...
        [Fact]
        public void MigrateDefaultFeedToNewerProtocol_NoOpsIfNuGetOrgSourceIsAbsent()
        {
            using (var mockBaseDirectory = TestFilesystemUtility.CreateRandomTestFolder())
            {
                // Arrange
...
<configuration>
    <packageSources>
        ...
        <add key=""test1"" value = ""//test/source"" />
    </packageSources>
    <disabledSources />
    <config>
...
";
        ...
        public void MigrateDefaultFeedToNewerProtocol_NoOpsIV3SourceIsAlreadyPresent(string feed)
        {
            using (var mockBaseDirectory = TestFilesystemUtility.CreateRandomTestFolder())
            {
                // Arrange
...
";
        ...
        [Fact]
        public void MigrateDefaultFeedToNewerProtocol_AddsV3SourceIfNotPresent()
        {
            using (var mockBaseDirectory = TestFilesystemUtility.CreateRandomTestFolder())
            {
                // Arrange
...
";
        ...
        [Fact]
        public void MigrateDefaultFeedToNewerProtocol_DoesNotChangeRelativeSources()
        {
            using (var mockBaseDirectory = TestFilesystemUtility.CreateRandomTestFolder())
            {
                // Arrange
...
";
        ...
        [Fact]
        public void MigrateDefaultFeedToNewerProtocol_DoesNotThrowIfConfigFileIsNotWritable()
        {
            using (var mockBaseDirectory = TestFilesystemUtility.CreateRandomTestFolder())
            {
                // Arrange
