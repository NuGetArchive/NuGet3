...
namespace NuGet.Commands
{
    public class RestoreRequest
    {
        ...
        /// <summary>
        /// Determines the behavior of the lock file generated by this command
        /// </summary>
        public LockBehavior Lock { get; set; }
    }

    /// <summary>
    /// Defines the possible lock behaviors for the <see cref="RestoreCommand"/>
    /// </summary>
    public enum LockBehavior
    {
        /// <summary>
        /// If a locked lockfile is present, it will be used to constrain the restore process and left
        /// unmodified. Otherwise, a new unlocked lockfile will be written.
        /// </summary>
        Unchanged,

        /// <summary>
        /// The current lockfile will be ignored and a new, locked, lockfile will be generated.
        /// </summary>
        Lock,

        /// <summary>
        /// The current lockfile will be ignored and a new, unlocked, lockfile will be generated.
        /// </summary>
        Unlock
    }
}
