...
//        public IList<string> FallbackSource => new List<string>();
...
//            var packageSources = Source.Select(s => new Configuration.PackageSource(s));
...
//            packageSources = packageSources.Concat(FallbackSource.Select(f => new Configuration.PackageSource(f)));
